...
const CreateComment = ({setPage, setCommentDetails}) => {
    ...
    return(
        <div className="main_body">
            ...
            <div className="buttons">
                ...
                <button className="button" onClick={() => {if(window.confirm("Are you sure you want to submit this comment?")){setPage("insert_comment")}}}>Submit</button>
            </div>
        </div>
    );
}
